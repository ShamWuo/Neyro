...
export async function GET(
  ...
  try {
    ...
    try {
      ...
      console.warn("Rate limiter check failed, allowing area goals GET request:", e?.message || e);
    }
...
export async function POST(
  ...
  try {
    ...
    try {
      ...
      // eslint-disable-next-line no-console
      console.warn("Rate limiter check failed, allowing area goals POST request:", e?.message || e);
    }
