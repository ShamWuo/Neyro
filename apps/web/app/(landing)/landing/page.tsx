      ...
      <header className="sticky top-0 z-50 border-b border-border-glass bg-bg-surface-glass backdrop-blur-md">
        <div className="w-full max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
          ...
          <nav className="hidden md:flex items-center gap-8">
            <Link className="text-sm font-medium hover:text-accent transition-colors text-slate-300" href="#">Method</Link>
            <Link className="text-sm font-medium hover:text-accent transition-colors text-slate-300" href="#">Pricing</Link>
            <Link className="text-sm font-medium hover:text-accent transition-colors text-slate-300" href="#">Blog</Link>
          </nav>
      ...
      <main className="flex-grow z-10 flex flex-col items-center w-full">
        ...
        <section className="w-full max-w-7xl px-4 md:px-10 pt-24 pb-16 flex flex-col items-center text-center">
          ...
          <div className="flex flex-wrap gap-4 justify-center w-full">
            ...
            <button className="h-14 px-8 rounded-full bg-transparent border border-white/10 hover:bg-white/5 text-foreground font-bold text-base transition-all flex items-center gap-2 hover:border-white/20">
        ...
        <footer className="w-full max-w-7xl px-4 md:px-10 py-16">
          <div className="flex flex-col md:flex-row justify-between items-center gap-8 border-t border-white/10 pt-12">
            ...
            <div className="flex gap-4">
              <a className="size-10 rounded-full bg-white/5 hover:bg-primary/20 flex items-center justify-center text-slate-400 hover:text-accent transition-all" href="#">
