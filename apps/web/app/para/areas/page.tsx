...
import { FolderOpen, Search, Filter, Plus, Activity, X, Compass, ChevronRight, Hash, Sparkles, Folder } from 'lucide-react';
                        ...
                        >
                            ...
                            >
                                <CardContent className="p-6 flex flex-col h-full">
                                    ...
                                    <p className="text-[13px] text-secondary leading-relaxed line-clamp-2">"{area.insight}"</p>
