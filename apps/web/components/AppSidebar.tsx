...
import { Zap, Compass, Folder, Circle, Bookmark, Archive, LineChart, CheckSquare, Settings, Inbox, Play } from 'lucide-react';
    ...
    const navSections = [
        {
            ...
            items: [
                ...
                { icon: Inbox, label: 'Inbox', href: '/para/inbox' },
                { icon: Play, label: 'Focus', href: '/para/focus' },
