                        ...
                        >
                            ...
                            <div className="px-4 pb-3">
                                ...
                                <div className="flex items-center gap-2 mt-2 flex-wrap">
                                    <button 
                                        onClick={() => toast({ title: "Voice Capture", description: "Audio recording coming soon to web!" })}
                                    ...
                                    <button 
                                        onClick={() => toast({ title: "Photo Capture", description: "Camera access coming soon!" })}
                                        className="px-2.5 py-1.5 border border-border rounded-button text-text-muted hover:text-primary hover:bg-hover transition-colors flex items-center gap-1.5 text-[11px] font-semibold tracking-[0.02em]"
                                    >
                                        <ImageIcon size={12} /> Photo
                                    </button>
                                    <button 
                                        onClick={() => toast({ title: "Link Scraper", description: "URL metadata extraction is in development." })}
                                        className="px-2.5 py-1.5 border border-border rounded-button text-text-muted hover:text-primary hover:bg-hover transition-colors flex items-center gap-1.5 text-[11px] font-semibold tracking-[0.02em]"
                                    >
                                        <Link2 size={12} /> Link
                                    </button>
